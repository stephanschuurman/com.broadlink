...
class BroadlinkDevice extends Homey.Device {
  ...
  async reDiscoverIpAddress(timeout = 500) {
    ...
    try {
      ...
      const broadLinkDevicesFound = await this._communicate.discover(timeout, localHomeyIpAddress, null);
      ...
      if (this._communicate && matchingDevice.ipAddress !== deviceSettings.ipAddress)
